...
func (c *pingPongClient) PingMessage(ctx context.Context, in *PingPongRequest, opts ...grpc.CallOption) (*PingPongResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ping.proto.PingPong/PingMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PingPong_PingMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ping.proto.PingPong/PingMessage",
	}
...
var PingPong_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ping.proto.PingPong",
	...
	Metadata: "grpc/proto/ping.proto",
}
